...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("netherscape"), bytes16("ParcelTerrain")));
bytes32 constant ParcelTerrainTableId = _tableId;

library ParcelTerrain {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ParcelTerrain", _fieldNames);
  }
