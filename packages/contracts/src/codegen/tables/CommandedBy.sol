...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("netherscape"), bytes16("CommandedBy")));
bytes32 constant CommandedByTableId = _tableId;
...
library CommandedBy {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CommandedBy", _fieldNames);
  }
