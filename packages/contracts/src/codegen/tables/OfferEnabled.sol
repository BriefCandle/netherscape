...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("netherscape"), bytes16("OfferEnabled")));
bytes32 constant OfferEnabledTableId = _tableId;

library OfferEnabled {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("OfferEnabled", _fieldNames);
  }
